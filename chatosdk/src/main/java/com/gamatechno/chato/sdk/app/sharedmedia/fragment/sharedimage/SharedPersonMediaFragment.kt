...
import com.gamatechno.chato.sdk.app.sharedmedia.adapter.SharedMediaPersonImageAdapter
import com.gamatechno.chato.sdk.data.DAO.Chat.Chat
import com.gamatechno.chato.sdk.data.constant.Api
import kotlinx.android.synthetic.main.fragment_shared_media.*

class SharedPersonMediaFragment: Fragment(), SharedMediaView.View {

    lateinit var adapter: SharedMediaPersonImageAdapter
...
//    lateinit var roomId : String
    ...
    private fun initList() {
        ...
        adapter = SharedMediaPersonImageAdapter(context!!)

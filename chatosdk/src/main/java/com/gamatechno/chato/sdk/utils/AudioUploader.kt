...
class AudioUploader(context: Context, loading: Loading, uri: Uri, isneedLoading: Boolean, onUploadAudio: OnUploadAudio) {
    init {
            ...
            override fun onSuccess(response: JSONObject?) {
                ...
                try {
                    if (response!!.getBoolean("success")) {
                        ...
                        onUploadAudio.onSuccessUploadAudio(obj.getString("file_url"))
                    } else {
                        onUploadAudio.onFailedUploadAudio(response.getString("message"))
                    }
    ...
    interface OnUploadAudio{
        fun onSuccessUploadAudio(url: String)
        fun onFailedUploadAudio(message: String)
    }
}
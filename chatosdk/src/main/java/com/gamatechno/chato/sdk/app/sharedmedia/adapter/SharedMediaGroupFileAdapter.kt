...
class SharedMediaGroupFileAdapter(var context: Context) : RecyclerView.Adapter<SharedMediaGroupFileAdapter.Holder>() {
        ...
        vh.view.setOnClickListener {
            if (GGFWUtil.isValidURL(chat.message_attachment)) {
                ...
                if (IOUtils.isFileExist(fileUri.toString().replace("file:/", ""))) {
                    ...
                    (context as GroupInfoNewActivity).permission(object : GroupInfoNewActivity.AskPermission{

...
import com.gamatechno.chato.sdk.app.sharedmedia.adapter.SharedMediaGroupFileAdapter
import com.gamatechno.chato.sdk.data.DAO.Chat.Chat
import com.gamatechno.chato.sdk.data.constant.Api
import kotlinx.android.synthetic.main.fragment_shared_media.*

class SharedGroupFileFragment: Fragment(), SharedFileView.View {

    lateinit var adapter: SharedMediaGroupFileAdapter
    ...
    private fun initList() {
        ...
        adapter = SharedMediaGroupFileAdapter(context!!)

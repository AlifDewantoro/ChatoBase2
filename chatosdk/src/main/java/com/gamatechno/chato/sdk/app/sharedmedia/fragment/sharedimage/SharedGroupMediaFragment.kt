...
import com.gamatechno.chato.sdk.app.sharedmedia.adapter.SharedMediaGroupImageAdapter
import com.gamatechno.chato.sdk.data.DAO.Chat.Chat
import com.gamatechno.chato.sdk.data.constant.Api
import kotlinx.android.synthetic.main.fragment_shared_media.*

class SharedGroupMediaFragment: Fragment(), SharedMediaView.View {

    lateinit var adapter: SharedMediaGroupImageAdapter
...
//    lateinit var roomId : String
    ...
    private fun initList() {
        ...
        adapter = SharedMediaGroupImageAdapter(context!!)
